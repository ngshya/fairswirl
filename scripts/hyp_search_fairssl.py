...
model_fairssl = FairSSL(cr=args.cr, f=args.f, base_model=args.base_model, seed=my_seed)
...
y_train_l_pred = model_fairssl.predict(X_train)
y_train_u1_pred = model_fairssl.predict(dict_data["U"]["X"][:n_half_train,:])
y_train_u2_pred = model_fairssl.predict(dict_data["U"]["X"][n_half_train:,:])
y_train_pred = model_fairssl.predict(X_train_with_U)
y_val_pred = model_fairssl.predict(dict_data["V"]["X"])
